...
{
    self.schema = [VVJSONSchema schemaWithDictionary:self.schemaObject baseURI:nil referenceStorage:schemaStorage specification:self.specification error:error];
